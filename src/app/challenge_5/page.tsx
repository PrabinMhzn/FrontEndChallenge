  ...
  return (
    <>
      <div className="flex bg-cream-5 min-h-screen items-center justify-center p-4 ">
        <div className="flex flex-col md:flex-row bg-white rounded-xl w-full max-w-md md:max-w-2xl overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row p-8  w-full md:w-1/2">
            <div>
              <h3 className="uppercase text-DarkGrayBlue-5 font-Montserrat text-md my-4 md:my-6 tracking-custom font-montserrat">
                perfume
              </h3>
              <h1 className="text-3xl md:text-4xl font-fraunces font-extrabold my-4 md:mb-8 text-DarkBlue-5">
                Gabrielle Essence Eau De Parfum
              </h1>
              <p className="text-DarkGrayBlue-5 text-sm md:mb-6 md:text-md font-montserrat font-medium ">
