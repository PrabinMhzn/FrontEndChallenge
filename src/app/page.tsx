...
export default function Home() {
  return (
    <main className="flex  h-screen flex-col items-center justify-between p-24 bg-slate-200 w-screen">
        ...
        <ul className="mt-8 ">
          <li className=" flex  flex-col text-center">
            <Link href="/challenge_1">
              <h1 className="hover:text-slate-300 bg-slate-500 p-4 rounded-lg mb-4 hover:scale-110 duration-300">
